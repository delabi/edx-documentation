...
To receive a certificate, learners must enroll in the verified track for a
course, verify their identity, and earn a passing grade.
...
EdX currently offers the folowing types of certificates: a verified certificate for a
single course, and an XSeries certificate for a series of courses. Not all
...
* The name that is listed as your full name in your account settings.

  To make sure that the name on your certificate is correct, you must make sure
  that the name in your account settings is correct before your course ends.
  For more information, see :ref:`SFD Basic Information`.
...
.. note::
  ...
  need proof of your grade, you can print your **Progress** page or dashboard.
